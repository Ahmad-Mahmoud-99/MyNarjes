                  ...
                  <div class="col-md-5 mr-auto" style="margin-right: 0%;">
                    ...
                    <div class="form-group has-default">
                      <div class="input-group">
                          ...
                          <label>Start date:
                          <input  type="date" class="form-control" name="start_date"value="{{old('start_date')}}" ></label>
                          @error('start_date')
                              <span class="text-danger">{{$message}} </span>
                           @enderror
                        </div>
                  ...
                  <div class="col-md-5 mr-auto" style="margin-right: 0%;">
                      <div class="form-group has-default">
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control"name="m_name" value="{{old('m_name')}}" placeholder="Middle Name...">
                          @error('m_name')
                              <span class="text-danger">{{$message}} </span>
                           @enderror
                        </div>
